      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: validatedField ? AppColors.grey : AppColors.red),
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                InkWell(
                  onTap: tapObscure,
                  child: Icon(!enableObscure ? Icons.lock_open : Icons.lock, color: AppColors.contrast),
                ),
                if(!password)
                InkWell(
                  onTap: tapObscure,
                  child: Icon(Icons.email, color: AppColors.contrast),
                )
              ]
            )
          )
        ),
        Container(width: 300,child: Text(validatedField ? '' : 'Validar campo', style: TextStyle(color: AppColors.red),))
      ],
    );
  }
}